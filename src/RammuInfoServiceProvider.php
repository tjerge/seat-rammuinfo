...
namespace MrMajestic\Seat\RammuInfo;

use Seat\Services\AbstractSeatPlugin;

/**
 * Class MajesticServiceProvider.
 *
 * @package Author\Seat\YourPackage
 */
class RammuInfoServiceProvider extends AbstractSeatPlugin
{
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/Config/rammuinfo.config.php', 'rammuinfo.config');
        $this->mergeConfigFrom(__DIR__ . '/Config/rammuinfo.locale.php', 'rammuinfo.locale');
    ...
    private function add_publications()
    {
        $this->publishes([
            ...
            __DIR__ . '/resources/img' => public_path('rammuinfo/img'),
            __DIR__ . '/resources/js' => public_path('rammuinfo/js'),
        ], ['public', 'seat']);
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/resources/lang', 'rammuinfo');
    }
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/resources/views', 'rammuinfo');
    }
    ...
    {
        return 'https://github.com/tjerge/seat-rammuinfo/';
    }
    ...
    {
        return config('rammuinfo.config.version');
    }
    
    public function getMajesticView()
    {
        return view("rammuinfo::home");
    }
}
